@echo off
:: Upload selected taBOX files from local folder to KL target path (force overwrite)
...
echo put taBOX_MR508002.json /home/yf/GitPS/taBOX/taBOX_MR508002.json
...
sftp yf@KL < _sftp_batch.txt

del _sftp_batch.txt
echo.
echo Upload to KL complete from current directory
